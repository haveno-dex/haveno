...
/**
* Validates an Hyperliquid address using the regular expression on record in the
...
* @since 0.7.0
*/
public class HypeAddressValidator extends RegexAddressValidator {

    public HypeAddressValidator() {
        super("^(0x)?[0-9a-fA-F]{40}$");
    }

    public HypeAddressValidator(String errorMessageI18nKey) {
