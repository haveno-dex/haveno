...
public class CurrencyCodeOptionParser extends AbstractMethodOptionParser implements MethodOpts {

    final OptionSpec<String> currencyCodeOpt = parser.accepts(OPT_CURRENCY_CODE, "currency-code")
            .withRequiredArg();

    public CurrencyCodeOptionParser(String[] args) {
        super(args);
    }

    public CurrencyCodeOptionParser parse() {
        super.parse();
