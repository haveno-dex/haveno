...
public class CreateXmrSweepTxsOptionParser extends AbstractMethodOptionParser implements MethodOpts {

    final OptionSpec<String> addressOpt = parser.accepts(OPT_ADDRESS, "destination xmr address")
            .withRequiredArg();

    public CreateXmrSweepTxsOptionParser(String[] args) {
        super(args);
    }

    public CreateXmrSweepTxsOptionParser parse() {
        super.parse();
