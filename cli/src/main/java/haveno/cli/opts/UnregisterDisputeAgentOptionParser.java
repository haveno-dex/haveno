...
public class UnregisterDisputeAgentOptionParser extends AbstractMethodOptionParser implements MethodOpts {

    final OptionSpec<String> disputeAgentTypeOpt = parser.accepts(OPT_DISPUTE_AGENT_TYPE, "dispute agent type")
            .withRequiredArg();

    public UnregisterDisputeAgentOptionParser(String[] args) {
        super(args);
    }

    public UnregisterDisputeAgentOptionParser parse() {
        super.parse();
