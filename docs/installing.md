...
You can fund the two wallets by mining some stagenet XMR coins to those addresses. To do so, open the terminal where you ran `make monerod` and run: `start_mining ADDRESS 1`.
