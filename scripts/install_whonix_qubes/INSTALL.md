...
```shell
% sudo bash QubesIncoming/dispXXXX/1.0-haveno-templatevm.sh "https://github.com/havenoexample/haveno-example/releases/download/1.2.3/haveno-v1.2.3-linux-x86_64-installer.deb" "ABAF11C65A2970B130ABE3C479BE3E4300411886"
```
