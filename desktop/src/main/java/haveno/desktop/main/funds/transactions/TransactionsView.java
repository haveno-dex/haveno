...
public class TransactionsView extends ActivatableView<VBox, Void> {
    ...
    @FXML
    TableColumn<TransactionsListItem, TransactionsListItem> dateColumn, detailsColumn, addressColumn, transactionColumn, amountColumn, tradeFeeColumn, memoColumn, confidenceColumn, revertTxColumn;
    @FXML
    Label numItems;
    @FXML
    Region spacer;
    ...
    public void initialize() {
        ...
        tradeFeeColumn.setGraphic(new AutoTooltipLabel(Res.get("shared.tradeFeeWithCur", Res.getBaseCurrencyCode())));
...
//            e.printStackTrace();
    ...
    private void setTradeFeeColumnCellFactory() {
        tradeFeeColumn.setCellValueFactory((addressListItem) ->
                new ReadOnlyObjectWrapper<>(addressListItem.getValue()));
                    ...
                    public TableCell<TransactionsListItem, TransactionsListItem> call(TableColumn<TransactionsListItem,
                        ...
                        return new TableCell<>() {
                            ...
                            public void updateItem(final TransactionsListItem item, boolean empty) {
                                ...
                                if (item != null && !empty) {
                                    setGraphic(new AutoTooltipLabel(item.getTradeFeeStr()));
                                } else {
                                    setGraphic(null);
                                }
                            }
