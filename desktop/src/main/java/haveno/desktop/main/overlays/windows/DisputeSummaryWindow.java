...
public class DisputeSummaryWindow extends Overlay<DisputeSummaryWindow> {
    ...
    private void addContent() {
        ...
        if (applyPeersDisputeResult) {
            ...
            disableTradeAmountPayoutControls();
        } else if (trade.isMissingUnlockedDepositTx()) { // TODO: this can cause arbitrator to hang when they click the close ticket button (while opening the wallet if needed), so load it off main thread and add spinny wheel to ui?
