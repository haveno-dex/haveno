...
public class CryptoAccountsView extends PaymentAccountsView<GridPane, CryptoAccountsViewModel> {
    ...
    protected void buildForm() {
        ...
        int prefNumRows = Math.min(5, Math.max(2, model.dataModel.getNumPaymentAccounts()));
        paymentAccountsListView.setMinHeight(prefNumRows * Layout.LIST_ROW_HEIGHT + 10);
        paymentAccountsListView.setMaxHeight(prefNumRows * Layout.LIST_ROW_HEIGHT + 10);
