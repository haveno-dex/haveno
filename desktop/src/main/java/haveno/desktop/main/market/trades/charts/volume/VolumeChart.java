         ...
         for (int seriesIndex = 0; seriesIndex < getData().size(); seriesIndex++) {
             ...
             while (iterator.hasNext()) {
                 ...
                 if (itemNode instanceof VolumeBar && candleData != null) {
                     ...
                     // So we subtract 43 from the height to get the height for the bar to the bottom.
                     final double height = getHeight() - 43;
                     double upperYPos = Math.min(height - 5, y); // We want at least 5px height to allow tooltips
