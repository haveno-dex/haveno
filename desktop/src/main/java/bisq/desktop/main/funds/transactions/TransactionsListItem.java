...
//
//        Coin valueSentToMe = xmrWalletService.getValueSentToMeForTransaction(transaction);
//        Coin valueSentFromMe = xmrWalletService.getValueSentFromMeForTransaction(transaction);
//
...
//                if (!xmrWalletService.isTransactionOutputMine(output)) {
//                    received = false;
...
//            }
//        };
//        xmrWalletService.addTxConfidenceListener(txConfidenceListener);
