...
public class BuyerStep4View extends TradeStepView {
    ...
    protected void addContent() {
        ...
        HBox hBox = new HBox();
        hBox.setSpacing(10);
        useSavingsWalletButton = new AutoTooltipButton(Res.get("portfolio.pending.step5_buyer.moveToMisqWallet"));
    ...
    private void reviewWithdrawal() {
        ...
        if (true) throw new RuntimeException("BuyerStep4View.reviewWithdrawal() not yet updated for XMR");
