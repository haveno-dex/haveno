...
public class ProcessInitTradeRequestTest {
    ...
    @BeforeEach
    public void setup() {
        peerPubKeyRing = mock(PubKeyRing.class);
    ...
    public void testDifferentCounterpartyDoesNotMatch() {
        Trade other = mockTrade(BuyerAsMakerTrade.class, "other", tradePeer("acct", null), tradePeer(null, mock(PubKeyRing.class)), true, VOLUME);
