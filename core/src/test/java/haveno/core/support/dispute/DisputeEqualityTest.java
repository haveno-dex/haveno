...
public class DisputeEqualityTest {
    ...
    public void equalByIdentityAcrossInstances() {
        // Regression: disputeResultProperty (identity equality) was in @EqualsAndHashCode, so two
        // instances of the same dispute never matched, defeating the disputeList.contains() dedup.
