...
//          System.out.println(trade);
            ...
            synchronized (lock) {
                ...
                if (message.getSenderNodeAddress().equals(trade.getMakerNodeAddress()))
                    multisigParticipant = processModel.getMaker();
                else if (message.getSenderNodeAddress().equals(trade.getTakerNodeAddress()))
                ...
                if (multisigParticipant.getPreparedMultisigHex() == null)
                    multisigParticipant.setPreparedMultisigHex(message.getPreparedMultisigHex());
                else if (!multisigParticipant.getPreparedMultisigHex().equals(message.getPreparedMultisigHex()))
                    throw new RuntimeException("Message's prepared multisig differs from previous messages");
                if (multisigParticipant.getMadeMultisigHex() == null)
                    multisigParticipant.setMadeMultisigHex(message.getMadeMultisigHex());
                else if (!multisigParticipant.getMadeMultisigHex().equals(message.getMadeMultisigHex()))
