...
public abstract class Trade extends XmrWalletBase implements Tradable, Model {
    ...
    public boolean isDepositsPublished() {
        ...
        return getState().getPhase().ordinal() >= Phase.DEPOSITS_PUBLISHED.ordinal() && getMaker().getDepositTxHash() != null && (hasBuyerAsTakerWithoutDeposit() || getTaker().getDepositTxHash() != null);
    }
