...
public class ProcessInitTradeRequest extends TradeTask {
    ...
    static Trade findIndistinguishableTrade(Trade trade, boolean selfIsBuyer, String selfPaymentAccountId, PubKeyRing peerPubKeyRing, List<Trade> otherTrades, User user) {
        ...
        for (Trade otherTrade : otherTrades) {
            ...
            if (!peerPubKeyRing.equals(otherPeerPubKeyRing)) continue;
