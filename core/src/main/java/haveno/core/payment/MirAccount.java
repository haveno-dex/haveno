...
public final class MirAccount extends CountryBasedPaymentAccount {
    ...
    public MirAccount() {
        super(PaymentMethod.MIR);
        setSingleTradeCurrency(SUPPORTED_CURRENCIES.get(0)); // this payment method is only for Russia/RUB
    }

    @Override
    protected PaymentAccountPayload createPayload() {
        return new MirAccountPayload(paymentMethod.getId(), id);
    }

    public void setHolderName(String holderName) {
        ((MirAccountPayload) paymentAccountPayload).setHolderName(holderName);
    }

    public String getHolderName() {
        return ((MirAccountPayload) paymentAccountPayload).getHolderName();
    }
    ...
    public void setAccountNr(String accountNr) {
        ...
        ((MirAccountPayload) paymentAccountPayload).setAccountNr(accountNr);
    }

    public String getAccountNr() {
        return ((MirAccountPayload) paymentAccountPayload).getAccountNr();
    }

    @Override
    public String getMessageForBuyer() {
        return "payment.mir.info.buyer";
    }

    @Override
    public String getMessageForSeller() {
        return "payment.mir.info.seller";
    }

    @Override
    public String getMessageForAccountCreation() {
        return "payment.mir.info.account";
    }
    ...
    public void validateFormField(PaymentAccountForm form, PaymentAccountFormField.FieldId fieldId, String value) {
        switch (fieldId) {
            case ACCOUNT_NR:
                processValidationResult(new MirValidator().validate(value));
                break;
            default:
