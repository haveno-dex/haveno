...
@Getter
@Slf4j
public final class SbpAccountPayload extends CountryBasedPaymentAccountPayload {
    ...
    public Message toProtoMessage() {
        protobuf.SbpAccountPayload.Builder builder = protobuf.SbpAccountPayload.newBuilder()
                .setHolderName(holderName)
                .setMobileNr(mobileNr);
        final protobuf.CountryBasedPaymentAccountPayload.Builder countryBasedPaymentAccountPayload = getPaymentAccountPayloadBuilder()
                .getCountryBasedPaymentAccountPayloadBuilder()
                .setSbpAccountPayload(builder);
    ...
    public static SbpAccountPayload fromProto(protobuf.PaymentAccountPayload proto) {
        ...
        protobuf.SbpAccountPayload accountPayloadPB = countryBasedPaymentAccountPayload.getSbpAccountPayload();
