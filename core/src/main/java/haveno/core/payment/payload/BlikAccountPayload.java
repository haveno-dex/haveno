...
public final class BlikAccountPayload extends CountryBasedPaymentAccountPayload {
    ...
    public BlikAccountPayload(String paymentMethod, String id) {
        super(paymentMethod, id);
    }

    private BlikAccountPayload(String paymentMethod,
                               String id,
                               String countryCode,
    ...
    public static BlikAccountPayload fromProto(protobuf.PaymentAccountPayload proto) {
        protobuf.CountryBasedPaymentAccountPayload countryBasedPaymentAccountPayload = proto.getCountryBasedPaymentAccountPayload();
        protobuf.BlikAccountPayload accountPayloadPB = countryBasedPaymentAccountPayload.getBlikAccountPayload();
    ...
    public String getPaymentDetails() {
        return Res.get(paymentMethodId) + " - " + Res.getWithCol("payment.shared.extraInfo") + " " + extraInfo;
    }
