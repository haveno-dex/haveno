...
public final class MpesaAccountPayload extends CountryBasedPaymentAccountPayload {
    ...
    public MpesaAccountPayload(String paymentMethod, String id) {
        super(paymentMethod, id);
    }

    private MpesaAccountPayload(String paymentMethod,
                                String id,
                                String countryCode,
    ...
    public Message toProtoMessage() {
        protobuf.MpesaAccountPayload.Builder builder = protobuf.MpesaAccountPayload.newBuilder()
    ...
    public static MpesaAccountPayload fromProto(protobuf.PaymentAccountPayload proto) {
        protobuf.CountryBasedPaymentAccountPayload countryBasedPaymentAccountPayload = proto.getCountryBasedPaymentAccountPayload();
        protobuf.MpesaAccountPayload accountPayloadPB = countryBasedPaymentAccountPayload.getMpesaAccountPayload();
