...
public class Offer implements NetworkPayload, PersistablePayload {
    ...
    public String getExtraInfo() {
        ...
        else if (getExtraDataMap() != null && getExtraDataMap().containsKey(OfferPayload.CARDLESS_CASH_EXTRA_INFO))
            return getExtraDataMap().get(OfferPayload.CARDLESS_CASH_EXTRA_INFO);
        else
            return "";
    }
