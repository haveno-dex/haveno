...
public class CoinUtil {
    ...
    static BigInteger getAdjustedAmount(BigInteger amount, Price price, BigInteger minAmount, BigInteger maxAmount, int factor) {
        ...
        // Correct the amount toward the min/max bounds by the smallestUnitForAmount, guarding
        // against a non-positive step (per-unit amount rounds to zero) which would loop forever.
